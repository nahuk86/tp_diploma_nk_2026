    ...
    public partial class SalesForm : Form
    {
        ...
        private void LoadClients()
        {
            try
            {
                ...
                cmbClient.Items.Add(new ComboBoxItem { Text = "(Sin cliente)", Value = null });
        ...
        private string GetClientNameById(int clientId)
        {
            ...
            return client != null ? $"{client.Nombre} {client.Apellido}" : "(Desconocido)";
        }
        ...
        private void UpdateStockDisplay(DataGridViewRow row, int productId)
        {
            try
            {
                ...
                {
                    row.Cells[colStock.Index].Value = "Sin stock";
                }
                else
                {
        ...
        {
            txtSaleNumber.Text = "(Autogenerado)";
